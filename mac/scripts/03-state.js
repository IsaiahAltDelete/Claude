  ...
  Mac.DefaultState = {
    ...
    account: {
      ...
      family: {
        ...
        members: [
          { name: 'Alex Rivera', role: 'Organizer', initials: 'IS' },
          { name: 'Dana Whitfield', role: 'Adult', initials: 'DW' },
          { name: 'Milo Rivera', role: 'Child · 11', initials: 'MS' },
        ],
    ...
    /* --------------------------------------------------------------- Outlook */
    outlook: {
      account: { name: 'Alex Rivera', address: 'alex.rivera@support.example', org: 'Support Desk', initials: 'IS' },
      view: 'mail',
      folder: 'Inbox',
      focused: 'focused',
      selected: 'ol-1',
