...
Every face in this folder ships under the SIL Open Font License 1.1. The latin
subsets were taken from the corresponding @fontsource packages. Copyright
notices follow; the full licence text is reproduced once at the end.
